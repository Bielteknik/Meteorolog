...
class DataProcessor:
    ...
    def process(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        distance_mm = raw_data.get("height_raw")
        ...
        if distance_mm is not None:
            # Kar yüksekliği = Sensörün yerden yüksekliği - Sensörün kara mesafesi
        ...
        if snow_height_mm and snow_height_mm > 0 and current_weight_kg is not None:
            ...
            if volume_m3 > 0:
                ...
                # Kar-Su Eşdeğeri (Snow Water Equivalent - SWE) hesaplaması
                # SWE (mm) = Kar Derinliği (mm) * (Kar Yoğunluğu / Su Yoğunluğu)
                # Su yoğunluğu yaklaşık 1000 kg/m^3 olduğundan, formül basitleşir:
