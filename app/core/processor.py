# app/core/processor.py - NİHAİ VERSİYON
...
class DataProcessor:
    ...
    def analyze_burst_readings(self, readings: List[ProcessedReading]) -> ProcessedReading:
        ...
        status_cols = ["height_status", "weight_status", "temperature_status", "humidity_status"]
